...
public class DynamoDBUtil {
    ...
    static String tableName = "metrics-table";
...
//            System.out.println("Result: " + scanResult);
            ...
            System.out.println("Result Average : " + getAverage("dfs",100));
    ...
    public static long getAverage(String algorithm, int mazeSize) {
    	HashMap<String, Condition> scanFilter = new HashMap<String, Condition>();
    	...
    	Condition mazeSizeCondition = new Condition()
            .withComparisonOperator(ComparisonOperator.EQ.toString())
            .withAttributeValueList(new AttributeValue().withN(String.valueOf(mazeSize)));
        scanFilter.put("MazeSize", mazeSizeCondition);
